...
function Aboutcomponent() {
  ...
  return (
    <>
      ...
      >
        <center >
          <h2 className='about-title'>OUR CORE OBJECTIVES</h2>
        </center>
        <div>
      ...
      <div className="trustees">
        <h2 className='about-title'>OUR TRUSTEES</h2>
