...
export default function Footer() {
  return (
    <footer>
      <div className="footer-main">
        <div className="footer-content">
          <div className="footer-section logo-section">
            {/* Add Different Logos for Desktop & Mobile */}
            <div className="logo-section">
              <img src={logo} alt="Desktop Logo" className="footer-logo-desktop" />
              <img src={logo} alt="Mobile Logo" className="footer-logo-mobile" />
            </div>
          ...
          <Link to='/about' className="footer-link"><h4 className="footer-heading">ABOUT US</h4></Link>
      ...
      <hr className="footer-full-width-hr" />
