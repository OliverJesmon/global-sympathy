...
import education from '../images/educationalsupport.png'
  ...
  return (
    <>
      ...
      <div className="education-support-container">
        ...
        <img
          src={EducationPic}
          alt="Educational Support Visual"
          className="education-support-image"
        />
      </div>
